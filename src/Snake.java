...
public class Snake {
    ...
    public void changeDirection(Direction newDirection) {
        if (newDirection == Direction.RIGHT && direction != Direction.LEFT) direction = newDirection;
        if (newDirection == Direction.LEFT && direction != Direction.RIGHT) direction = newDirection;
        if (newDirection == Direction.UP && direction != Direction.DOWN) direction = newDirection;
        if (newDirection == Direction.DOWN && direction != Direction.UP) direction = newDirection;
    }
